...
describe('Container', function () {
    describe('getParameter', function () {
        it.skip('should throw an exception on undefined parameter', function () {
        });

        it.skip('should return the parameter value', function () {
        });
    });

    describe('getService', function () {
        it.skip('should throw an exception on undefined service', function () {
        });
